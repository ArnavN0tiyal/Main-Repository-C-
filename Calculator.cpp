...
int main() {
    ...
    double addend1 = 0.0, addend2 = 0.0, minuend = 0.0, subtrahend = 0.0, multiplier = 0.0, multiplicand = 0.0, dividend = 0.0, divisor = 0.0, round_x = 0.0, absolute_x = 0.0, sqrt_x = 0.0, cuberoot_x = 0.0, base = 0.0, exponent = 0.0, exp_x = 0.0, log_x = 0.0, log10_x = 0.0, log2_x = 0.0, floor_x = 0.0, ceiling_x = 0.0, sin_x = 0.0, cos_x = 0.0, tan_x = 0.0, sinh_x = 0.0, cosh_x = 0.0, tanh_x = 0.0, arcsin_x = 0.0, arccos_x = 0.0, arctan_x = 0.0, Fahrenheit = 0.0, Celsius = 0.0, Kelvin = 0.0;
    double sum = addend1 + addend2, difference = minuend - subtrahend, product = multiplier * multiplicand, quotient = dividend / divisor, rounding = round(round_x), absolute_value = abs(absolute_x), square_root = sqrt(sqrt_x), cube_root = cbrt(cuberoot_x), power = pow(base, exponent), exp_result = exp(exp_x), natural_log = log(log_x), log_10_result = log10(log10_x), log_2_result = log2(log2_x), floor_result = floor(floor_x), ceiling_result = ceil(ceiling_x), sin_result = sin(sin_x), cos_result = cos(cos_x), tan_result = tan(tan_x), sinh_result = sinh(sinh_x), cosh_result = cosh(cosh_x), tanh_result = tanh(tanh_x), arcsin_result = asin(arcsin_x), arccos_result = acos(arccos_x), arctan_result = atan(arctan_x), Celsius_convert_1 = (Fahrenheit - 32) * 5 / 9, Kelvin_convert_1 = (Fahrenheit - 32) * 5 / 9 + 273.15, Fahrenheit_convert_1 = (Celsius * 9 / 5) + 32, Kelvin_convert_2 = Celsius + 273.15, Fahrenheit_convert_2 = (Kelvin - 273.15) * 9 / 5 + 32, Celsius_convert_2 = Kelvin - 273.15;
    do {
